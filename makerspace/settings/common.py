...
PROJ_DIR = ROOT_DIR.path('makerspace')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://doelf@localhost/doelf_makerspace'),
}
...
# STATICFILES_DIRS defines a list of directories (STATICFILES_DIRS) in your
...
WAGTAIL_SITE_NAME = "Makerspace"

# Base URL to use when referring to full URLs within the Wagtail admin backend -
# e.g. in notification emails. Don't include '/admin' or a trailing slash
BASE_URL = 'http://makerspace.django.group'
